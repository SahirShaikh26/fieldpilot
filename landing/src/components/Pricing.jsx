...
const TIERS = [
  {
    ...
    seats: 'Up to 5 seats',
    features: ['Activity logging', 'Project & customer tracking', 'Basic reports', 'Mobile app access'],
  ...
  },
  {
    ...
    features: ['Everything in Starter', 'Advanced analytics', 'CSV bulk import', 'Priority support'],
    cta: 'Start Free Trial',
    href: SIGNUP_URL,
    featured: true,
  },
