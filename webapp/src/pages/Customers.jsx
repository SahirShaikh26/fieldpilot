...
const s = {
  ...
  input: { padding:'8px 12px', border:'1px solid #d1d5db', borderRadius:7, fontSize:13, minWidth:240 },
  ...
  mcard: { background:'#fff', borderRadius:12, padding:32, width:480, maxHeight:'90vh', overflowY:'auto' },
